...
RUN wget -O /minecraft/downloads/craftbukkit.jar https://download.getbukkit.org/craftbukkit/craftbukkit-1.18.1.jar
RUN wget -O /minecraft/downloads/spigot.jar https://download.getbukkit.org/spigot/spigot-1.18.1.jar
...
# https://www.spigotmc.org/resources/dynmap.274/ (v3.3-beta-1)
