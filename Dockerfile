...
RUN wget -O /minecraft/downloads/craftbukkit.jar https://download.getbukkit.org/craftbukkit/craftbukkit-1.19.jar
RUN wget -O /minecraft/downloads/spigot.jar https://download.getbukkit.org/spigot/spigot-1.19.jar
